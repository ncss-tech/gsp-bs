...
# save(bs_spc, file = "C:/Users/stephen.roecker/OneDrive - USDA/data/bs_spc.RData")
...
load("C:/Users/stephen.roecker/OneDrive - USDA/data/bs_spc.RData")
...
s_sf <- subset(s_sf, !is.na(BS2) & year >= 1997)

mapview(s_sf, zcol = "BS2")

# saveRDS(s_sf, file = "C:/Users/stephen.roecker/OneDrive - USDA/data/bs_training_data_post1997.rds")
# saveRDS(s_sf, file = "C:/Users/stephen.roecker/OneDrive - USDA/data/bs_training_data_all.rds")
